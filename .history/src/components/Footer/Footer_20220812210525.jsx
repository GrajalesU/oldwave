      ...
      <div className={styles.infoSection}>
        ...
        <div class="container">
          ...
          <div class="accordion">
            ...
            <div class="inner-content para-hide p-1">
              <p>
                ...
                voluptatem iste beatae nisi ut libero dolor id esse suscipit
                fugiat, aspernatur amet? Quo molestias fuga distinctio, id
                itaque deserunt excepturi!
              </p>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio,
                voluptatem iste beatae nisi ut libero dolor id esse suscipit
          ...
          <div className="accordion">
            <button className="btn-toggle-show p-1">
              <span>Content</span>
              <i className="fa-solid fa-angle-down"></i>
            </button>
            <div className="inner-content para-hide p-1">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio,
                voluptatem iste beatae nisi ut libero dolor id esse suscipit
                fugiat, aspernatur amet? Quo adas molestias fuga distinctio, id
                itaque deserunt excepturi!
              </p>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio,
